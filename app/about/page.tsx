  ...
  return (
    <div>
      <section style={{ padding: '80px 40px 60px', textAlign: 'center', maxWidth: '700px', margin: '0 auto' }}>
        <div style={{ fontSize: '11px', fontWeight: '600', color: '#4F6BFF', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '12px' }}>ABOUT</div>
        ...
        <p style={{ fontSize: '16px', color: 'rgba(245,245,247,0.45)', lineHeight: '1.7', marginBottom: '0' }}>
      ...
      <section style={{ padding: '40px 40px 80px', maxWidth: '800px', margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '40px' }}>
          {[
            ...
            <div key={title} style={{ padding: '24px', borderRadius: '14px', background: 'rgba(245,245,247,0.02)', border: '1px solid rgba(245,245,247,0.06)' }}>
              <h3 style={{ fontSize: '15px', fontWeight: '700', color: '#fff', marginBottom: '10px' }}>{title}</h3>
              <p style={{ fontSize: '13px', color: 'rgba(245,245,247,0.45)', lineHeight: '1.7', margin: 0 }}>{text}</p>
            </div>
          ))}
        </div>

        <div style={{ padding: '32px', borderRadius: '16px', background: 'rgba(79,107,255,0.06)', border: '1px solid rgba(79,107,255,0.2)', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '14px', color: 'rgba(245,245,247,0.4)', marginBottom: '24px' }}>Free forever. No credit card required.</p>
          <Link href="/login" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '12px 28px', background: '#4F6BFF', color: '#fff', borderRadius: '10px', textDecoration: 'none', fontSize: '14px', fontWeight: '600' }}>
            Get started free →
          </Link>
        </div>
      </section>
